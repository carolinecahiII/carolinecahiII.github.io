        ...
        "#writing": `
                <div class="project-grid">
                    <div class="project-rectangle">
                        ...
                        <ul>
                            <li><strong>client:</strong> tech company <br> <strong>tone:</strong> instructional <br><br><br>
                            <a href="https://docs.google.com/document/d/10yxovtf0XFHcckG4ETZVKzPbxN0fqXwtlYb0fiD4X5E/edit?usp=drive_link">link!</a></li>
                        </ul>
                        </div>
                    <div class="project-rectangle">
                    <h3>web3 crypto wallet setup guide </h3>
                        <ul>
                            <li><strong>client:</strong> web3 gaming company <br> <strong>tone:</strong> casual, instructional<br><br><br>
                            <a href="https://docs.google.com/document/d/1Bk8NB4MUptcjj_ZTVbbbGUaS5Nxcn49tW1dRr50iYL4/edit?usp=drive_link">link!</a></li>
                        </ul>
                        </div>
                    <div class="project-rectangle">
                    <h3>project requirements document</h3>
                    <ul>
                        <li><strong>client:</strong> telecom company <br> <strong>tone:</strong> formal, instructional <br><br><br>
                        <a href="https://docs.google.com/document/d/1L4KKMECjntWg05MV2UCgb9lvWADxDx9s1xwuhBySrBg/edit?usp=sharing">link!</a></li>
                    </ul> </div>
                </div>
            `,
            "#wordpress": `
            ...
            "#academic": `
                <div class="project-grid">
                    ...
                    <h3>research grant proposal</h3>
                            <a href="https://docs.google.com/document/d/1oJoxE-SxyGnyLJ9VsFAFmmyqa3c8HXxTAsRKq6kT_gg/edit?usp=drive_link">link!</a></li>
                        </div>
                    <div class="project-rectangle">
                    <h3>cinematography and visual media paper</h3>
                    <a href="https://docs.google.com/document/d/1M9BvNq33Mdx9vL101uvhXiE_smcZLc8yGR7pq_cq0gw/edit?usp=drive_link">link!</a></li>
                </div>
                <div class="project-rectangle">
                    <h3>queer and decolonial studies paper</h3>
                    <a href="https://docs.google.com/document/d/1UW_LXlYUR0ZVfP38qXUNTkAjx61j0eOU2FLSPvKu1Ng/edit">link!</a></li>
                </div>
